...
#   from gui_databases import NextScreen # other screen
from kivy.clock import Clock
from test import NextScreen
import User_check
#Config.set('graphics', 'fullscreen', 'auto')# use "auto for user wish"
username=""
password=""
Username=""
New_password=""
class HomeScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        # Place buttons on top of the image
        ...
        self.place_button(0.7, 0.127, 'Forgot Password',60)  # blue color, font size 20

        # Add a styled text input box
        self.add_styled_text_input(0.42, 0.56, 'Username')
        self.add_styled_text_input(0.42, 0.38, 'Password')

    def show_invalid_credentials_label(self,text):
    ...
    def on_button_press(self, instance, button_label):
        ...
        if button_label == "Forgot Password":
            ...
            self.add_styled_text_input(0.42, 0.56, 'Username')
            self.add_styled_text_input(0.42, 0.38, 'New Password')
        if button_label == "Delete Account":
            User_check.delete_account(Username)
            self.show_invalid_credentials_label("Account deleted")
        ...
        if button_label == "Create":
            ...
            self.show_invalid_credentials_label("Account Created")
        ...
        if button_label == 'login' and User_check.check(username, password) == "access denied":
            self.show_invalid_credentials_label("Invalid login credentials")
